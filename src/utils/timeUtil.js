...
function getFormattedTime(timestamp) {
  ...
  } else if (delta >= day && delta < yestday) {
    return "昨天";
  } else if (delta >= yestday && delta < year) {
    return moment(timestamp).format("MM月YY日");
  } else if (delta > year) {
    return moment(timestamp).format("YYYY/MM/YY");
  }
}
